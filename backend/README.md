...
## Project Structure
    ...
    ├── ravindertestmobile__38307  # Django project configurations
...
1. Clone this repo and `cd ravindertestmobile__38307`
...
2. Clone this repo and `cd ravindertestmobile__38307`
